...
# 2. Listar registros
curl -H "Authorization: Bearer $TOKEN" http://localhost:8080/api/animals
...
|----------|---------|---------|
| `/api/animals` | GET / POST / PUT / DELETE | CRUD de Animal |
| `/api/adotantes` | GET / POST / PUT / DELETE | CRUD de Adotante |
| `/api/processoadocaos` | GET / POST / PUT / DELETE | CRUD de ProcessoAdocao |
| `/api/entrevistaadocaos` | GET / POST / PUT / DELETE | CRUD de EntrevistaAdocao |
